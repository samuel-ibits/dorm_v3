...
<body>
    <div class="forgot-password-holder">
        <div class="forgot-password-div">
            <div class="center-forgot">
                ...
                <form action="#!" class="forgot-password-form-1 form">
                    <h4>STEP 1</h4>
                ...
                <form action="#!" class="forgot-password-form-2 form">
                    <h4>STEP 2</h4>
                    <div class="btn-1">
                    ...
                    <div class="instruction-div">
                        ...
                        If you did not get the sms with 3(three) minutes, please send "forgot
                        password,username,phonenumber" to <span>08151519625</span> with your phone number to get your
                        new password
                    </div>

                </form>

                <form action="#!" class="forgot-password-form-3 form">
                    <h4>STEP 3</h4>
                    <div class="input-holder">
    ...
    <div class="screen-container">
        <div class="sub-screen-container login">
            <div class="center">
                <div class="top-form-canopy">
                    <img src="images/Asset 3@2x.png" alt="">
                </div>
                ...
                <form action="index.php" method="post" class="form">
                    ...
                    <h2 class="big-blue-title">Sell like a pro</h2>
                    <div class="input-holder">
                        <ion-icon name="person"></ion-icon> <input type="text" name="phone"
                            placeholder="Username or Phone number" required>
                    </div>

                    <div class="input-holder">
                        <ion-icon name="lock-open"></ion-icon> <input type="password" name="pass"
            ...
            <p class="forgot-password">
                Forgot passord? <a href="https://www.dorm.com.ng/forgotpassword.php"><span class="forgt-password">Click
                        here</span>
                </a> </p>
    ...
    <div class="sub-screen-container registration">
        <div class="center">
            ...
            <form action="index.php" class="form" method="post" enctype="multipart/form-data">
                <div class="input-holder">
                    <ion-icon name="person"></ion-icon> <input type="text" name="fname"
                ...
                <div class="input-holder">
                    <ion-icon name="call"></ion-icon> <input type="number" name="phone"
                        placeholder="Phone number" required>
                </div>
                <div class="input-holder">
                    <ion-icon name="person"></ion-icon> <input type="text" name="uname" placeholder="Username"
                        required>
                </div>
                <div class="input-holder">
                    <ion-icon name="lock-open"></ion-icon> <input type="password" name="pass"
                ...
                <div class="input-holder">
                    <ion-icon name="lock-open"></ion-icon> <input type="password" name="repass"
                        placeholder="Re-type assword" required>
                </div>

                <div class="input-holder">
                    <ion-icon name="location"></ion-icon> <input type="text" name="address" placeholder="Address"
                        required>
                </div>
                <div class="input-holder">
                ...
                <div class="input-holder">
                    <p class="sub">ID front</p>
                    <ion-icon name="id-card"></ion-icon> <input type="file" name="cardfront"
                        placeholder="idfront" required>
                </div>

                <div class="input-holder">
                    <p class="sub">ID back</p>
                    <ion-icon name="id-card"></ion-icon> <input type="file" name="cardback"
                        placeholder="id back">
                </div>
                ...
                <div class="input-holder">
                    <button name="signup" class="sign-up-btn">SIGN UP</button>
                </div>
