                ...
                <form role="form" method="post" id="reused_form">
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <p>
                                <label class="radio-inline">
                                    <form actio="" method=""> <input type="radio" name="useful"
                                            id="radio_experience" value="yes">
                                        Yes
                                </label>
                                <label class="radio-inline">
                    ...
                    <div class="row">
                        <div class="col-sm-12 form-group">
                            ...
                            <textarea class="form-control" type="textarea" name="newfeauture" id="comments" placeholder="Your Comments"
                    ...
                    <div class="row">
                        <div class="col-sm-12 form-group">
                            ...
                            <textarea class="form-control" type="textarea" name="teribleexp" id="comments" placeholder="Your Comments"
                                maxlength="6000" rows="7"></textarea>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label for="comments"> Suggest a solution to improve this app:</label>
                                <textarea class="form-control" type="textarea" name="improve" id="comments" placeholder="Your Comments"
                                    maxlength="6000" rows="7"></textarea>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 form-group">
